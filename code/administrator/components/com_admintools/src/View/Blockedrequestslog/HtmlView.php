...
class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar()
	{
		...
		ToolbarHelper::title(sprintf(Text::_('COM_ADMINTOOLS_TITLE_LOG')), 'icon-admintools');

		$canDelete = $user->authorise('core.delete', 'com_admintools');

		if ($canDelete)
		{
			$toolbar->delete('blockedrequestslog.delete')
		...
		ToolbarHelper::help(null, false, 'https://www.akeeba.com/documentation/admin-tools-joomla/waf-log.html');
	}
}