...
namespace Akeeba\Component\AdminTools\Administrator\View\Ipautobanhistories;
...
class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar()
	{
		...
		ToolbarHelper::title(sprintf(Text::_('COM_ADMINTOOLS_TITLE_IPAUTOBANHISTORIES')), 'icon-admintools');
		...
		if ($canDelete)
		{
			$toolbar->delete('ipautobanhistories.delete')
