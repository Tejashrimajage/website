...
namespace Akeeba\Component\AdminTools\Administrator\View\Badwords;

defined('_JEXEC') or die;

use Akeeba\Component\AdminTools\Administrator\Model\BadwordsModel;
use Akeeba\Component\AdminTools\Administrator\View\Mixin\LoadAnyTemplate;
use Akeeba\Component\AdminTools\Administrator\View\Mixin\SystemPluginExists;
...
class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar()
	{
		...
		ToolbarHelper::title(sprintf(Text::_('COM_ADMINTOOLS_TITLE_BADWORDS')), 'icon-admintools');
		...
		if ($canDelete || $canEditState || $canCreate)
		{
			...
			if ($canDelete)
			{
				$childBar->delete('badwords.delete')
