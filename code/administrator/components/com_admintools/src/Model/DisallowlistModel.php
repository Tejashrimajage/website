...
class DisallowlistModel extends AdminModel
{
	use CopyAware;
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_admintools.edit.disallowlist.data', []);
		$pk   = (int) $this->getState($this->getName() . '.id');
		$item = ($pk ? $this->getItem() : false) ?: [];

		$data = $data ?: $item;

		$this->preprocessData('com_admintools.disallowlist', $data);
