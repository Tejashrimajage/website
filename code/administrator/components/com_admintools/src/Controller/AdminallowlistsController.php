...
class AdminallowlistsController extends AdminController
{
	...
	protected $text_prefix = 'COM_ADMINTOOLS_ADMINALLOWLISTS';

	public function getModel($name = 'Adminallowlist', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
