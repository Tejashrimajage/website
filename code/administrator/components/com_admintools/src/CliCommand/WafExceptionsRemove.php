 ...
 *
 */
class WafExceptionsRemove extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:wafexceptions:remove';
	...
	protected function configure(): void
	{
		...
		$this->setDescription(Text::_('COM_ADMINTOOLS_CLI_WAFEXCEPTIONS_REMOVE_DESC'));
		$this->setHelp(Text::_('COM_ADMINTOOLS_CLI_WAFEXCEPTIONS_REMOVE_HELP'));
	}
}
