...
use Akeeba\Component\AdminTools\Administrator\Model\AutobannedaddressModel;
 ...
 *
 */
class AutobanRemove extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:autoban:remove';
	...
	protected function doExecute(InputInterface $input, OutputInterface $output): int
	{
		...
		/** @var AutobannedaddressModel $model */
		$model = $this->getMVCFactory()->createModel('Autobannedaddress', 'Administrator');
	...
	protected function configure(): void
	{
		...
		$this->setDescription(Text::_('COM_ADMINTOOLS_CLI_AUTOBAN_REMOVE_DESC'));
		$this->setHelp(Text::_('COM_ADMINTOOLS_CLI_AUTOBAN_REMOVE_HELP'));
	}
}
