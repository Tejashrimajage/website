...
use Akeeba\Component\AdminTools\Administrator\Model\IpautobanhistoriesModel;
 ...
 *
 */
class AutobanhistoryList extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:autobanhistory:list';
	...
	protected function doExecute(InputInterface $input, OutputInterface $output): int
	{
		...
		/** @var IpautobanhistoriesModel $model */
		$model = $this->getMVCFactory()->createModel('Ipautobanhistories', 'Administrator');

		$model->setState('list.start', 0);
		$model->setState('list.limit', 0);
		$model->setState('list.ordering', 'ip');
	...
	protected function configure(): void
	{
		...
		$this->setDescription(Text::_('COM_ADMINTOOLS_CLI_AUTOBANHISTORY_LIST_DESC'));
		$this->setHelp(Text::_('COM_ADMINTOOLS_CLI_AUTOBANHISTORY_LIST_HELP'));
	}
}
