...
use Akeeba\Component\AdminTools\Administrator\Model\BlockedrequestslogModel;
 ...
 *
 */
class LogRemove extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:log:remove';
	...
	protected function doExecute(InputInterface $input, OutputInterface $output): int
	{
		...
		/** @var BlockedrequestslogModel $model */
		$model = $this->getMVCFactory()->createModel('Blockedrequestslog', 'Administrator');
