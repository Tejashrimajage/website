 ...
 *
 */
class IpDisallowRemove extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:ipdisallow:remove';
	...
	protected function configure(): void
	{
		...
		$this->setDescription(Text::_('COM_ADMINTOOLS_CLI_IPDISALLOW_REMOVE_DESC'));
		$this->setHelp(Text::_('COM_ADMINTOOLS_CLI_IPDISALLOW_REMOVE_HELP'));
	}
}
