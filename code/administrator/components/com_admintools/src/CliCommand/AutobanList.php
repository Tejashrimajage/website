 ...
 *
 */
class AutobanList extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:autoban:list';
	...
	protected function doExecute(InputInterface $input, OutputInterface $output): int
	{
		...
		$model = $this->getMVCFactory()->createModel('Autobannedaddresses', 'Administrator');
	...
	protected function configure(): void
	{
		...
		$this->setDescription(Text::_('COM_ADMINTOOLS_CLI_AUTOBAN_LIST_DESC'));
		$this->setHelp(Text::_('COM_ADMINTOOLS_CLI_AUTOBAN_LIST_HELP'));
	}
}
