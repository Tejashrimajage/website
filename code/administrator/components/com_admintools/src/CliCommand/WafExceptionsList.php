 ...
 *
 */
class WafExceptionsList extends AbstractCommand
{
	use ConfigureEnv;
	use ConfigureIO;
	 ...
	 * @var    string
	 */
	protected static $defaultName = 'admintools:wafexceptions:list';
	...
	protected function doExecute(InputInterface $input, OutputInterface $output): int
	{
		...
		$model = $this->getMVCFactory()->createModel('Wafexceptions', 'Administrator');
