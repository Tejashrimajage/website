	...
	<div class="card-body">
			...
			<div class="alert alert-info">
				...
				<p>
					<a class="btn btn-primary me-3"
							href="https://www.akeeba.com/documentation/admin-tools-joomla/joomla-scheduled-tasks.html"
							target="_blank">
						<?= Text::_('COM_ADMINTOOLS_SCHEDULINGINFORMATION_LBL_GENERICREADDOC') ?>
					</a>
		...
		<?php elseif (version_compare(JVERSION, '4.1.0', 'lt')): ?>
			<div class="alert alert-warning">
				<h3 class="alert-heading">
					<?= Text::_('COM_ADMINTOOLS_SCHEDULINGINFORMATION_LBL_JOOMLASCHEDULER_ONLYJ41_HEAD') ?>
				</h3>
				<p>
					<?= Text::_('COM_ADMINTOOLS_SCHEDULINGINFORMATION_LBL_JOOMLASCHEDULER_ONLYJ41_BODY') ?>
				</p>
			</div>
		<?php else: ?>
			<div class="alert alert-warning">
